...
|---------|-------------|---------|
| **Role** | Sets the AI's perspective | "You are a technical recruiter reviewing this job description" |
| **Task** | The specific action | "Rewrite the requirements section to attract senior candidates" |
| **Constraints** | Boundaries and format | "Keep each bullet under 15 words. Avoid buzzwords like 'rockstar' or 'ninja'" |
| **Context** | The raw material | [paste job description] |
