...
1. **Short fiction:** A 500-word story from a specific prompt
2. **Poetry:** A sonnet on a given theme
3. **Screenwriting:** A 3-scene script excerpt
4. **World-building:** A fictional setting description
...
- [ChatGPT vs Claude vs Gemini: Full Comparison](/blog/chatgpt-vs-claude-vs-gemini) — Broader AI model comparison beyond creative writing
- [How to Use ChatGPT for Excel Formulas](/blog/how-to-use-chatgpt-for-excel-formulas) — Practical AI applications for non-writing tasks

*This article contains affiliate links for Claude and ChatGPT Plus. We may earn a commission if you subscribe through these links, at no additional cost to you.*
